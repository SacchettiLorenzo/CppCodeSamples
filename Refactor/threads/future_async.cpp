...
int main() {
	...
	future<int> the_answer4 = std::async(launch::async | launch::deferred, function4);
	function2();
	cout << the_answer3.get();
...
int function1() {
	cout << "function1 running\n";
	return 1;
}

int function2() {
	cout << "function2 running\n";
	return 2;
}

int function3(int param) {
	cout << "function3 running with " << param << endl;
	return param * 2;
}

int function4() {
	cout << "function4 running\n";
	return 4;
}
/* Future
